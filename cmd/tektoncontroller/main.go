...
func gatherOptions(fs *flag.FlagSet, args ...string) options {
	...
	fs.BoolVar(&o.rerunPipelineRunReconciler, "rerun-pr-reconciler", true, "Enables the rerun pipelinerun reconciler to run and update rerun pipelinerun status to github")
	err := fs.Parse(args)
	if err != nil {
